...
sed s#http://192.168.1.90/webapp/#$1#g $DIR/tap.sh > $DIR/tap.bak.sh
cat $DIR/tap.bak.sh > $DIR/tap.sh
rm $DIR/tap.bak.sh

sed s#http://192.168.1.90/webapp/#$1#g $DIR/xunit.sh > $DIR/xunit.bak.sh
cat $DIR/xunit.bak.sh > $DIR/xunit.sh
rm $DIR/xunit.bak.sh

sed s#http://192.168.1.90/webapp/#$1#g $DIR/coverage.sh > $DIR/coverage.bak.sh
