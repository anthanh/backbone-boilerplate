...
# bash apiGateway.sh http://192.168.1.163/welvi-dev/
# bash apiGateway.sh http://www.welvi.com/api/
# bash apiGateway.sh http://api.welvi.com/

# Relative path examples
# bash apiGateway.sh welvi-dev/
# bash apiGateway.sh welvi-pre/
...
# sed s#http://192.168.1.163/welvi-dev/#$1#g $DIR/../app/scripts/common.js > $DIR/../app/scripts/common.bak.js
